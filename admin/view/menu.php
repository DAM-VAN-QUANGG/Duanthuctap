                    ...
                    <ul class="sa-nav__menu sa-nav__menu--root">
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                            <a href="index.php" class="sa-nav__link"><span class="sa-nav__icon"><svg
                                    ...
                                    </svg></span><span class="sa-nav__title">Trang tổng quan</span></a>
                        </li>
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                            ...
                            <a href="#" class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon"><svg
                                    ...
                                    </svg></span><span class="sa-nav__title">Danh sách</span><span
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <a href="index.php?act=app-products-list" class="sa-nav__link"><span
                                            class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh
                        ...
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                            ...
                            <a href="#" class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon"><svg
                                    ...
                                    </svg></span><span class="sa-nav__title">Danh sách tài khoản</span><span
                                    class="sa-nav__arrow">
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <a href="index.php?act=app-customers-list" class="sa-nav__link"><span
                                            class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh
                                            sách khách hàng</span></a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="index.php?act=app-employee-list" class="sa-nav__link"><span
                                            class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh
                                            sách nhân viên</span></a>
                                </li>
                                <?php if ($_SESSION['user']['vai_tro'] == 3): ?>
                                    <li class="sa-nav__menu-item">
                                        <a href="index.php?act=app-admin-list" class="sa-nav__link"><span
                                                class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Danh
                                                sách admin</span></a>
                                    </li>
                                <?php endif; ?>
                        ...
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                            ...
                            <a href="#" class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon"><svg
                                    ...
                                    </svg></span><span class="sa-nav__title">Mã giảm giá</span><span
                                    class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                        viewBox="0 0 6 9" fill="currentColor">
                                        <path
                                            d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                ...
                                <!-- <li class="sa-nav__menu-item">
                                     <a href="index.php?act=app-coupon" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Coupon</span></a>
                                 </li> -->
                            </ul>
                        </li>
                        <!-- <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
