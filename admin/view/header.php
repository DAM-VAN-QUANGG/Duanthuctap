...
<!-- Mirrored from stroyka-admin.html.themeforest.scompiler.ru/variants/ltr/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Nov 2023 12:58:25 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="format-detection" content="telephone=no" />
    <title>ADMIN XĐQ-SHOP</title>
    <!-- icon -->
                ...
                <div class="sa-toolbar__body">
                        ...
                        <form class="sa-search sa-search--state--pending">
                            <div class="sa-search__body">
                                ...
                                <input type="text" id="input-search" class="sa-search__input"
                                    ...
                                    class="sa-search__cancel d-sm-none" type="button" aria-label="Close search">
                    ...
                    <div class="sa-toolbar__item dropdown">
                        ...
                        <!-- <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="#"><img
                                        src="view/vendor/flag-icons/24/FR.png" class="sa-language-icon me-3" alt="" /><span
                                        class="ps-2">French</span></a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="#"><img
                                        src="view/vendor/flag-icons/24/GB.png" class="sa-language-icon me-3" alt="" /><span
                                        class="ps-2">English</span></a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="#"><img
                                        src="view/vendor/flag-icons/24/RU.png" class="sa-language-icon me-3" alt="" /><span
                                        class="ps-2">Russian</span></a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="#"><img
