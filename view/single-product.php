                    ...
                    <form action="index.php?act=add-cart" method="post">
                        ...
                        <div class="cart-wishlist-btn mb-4">
                            <div class="add-to_cart">
                                ...
                                <input type="submit" class="btn btn-outline-dark btn-hover-primary"
                                    name="them_vao_gio_hang" value="Thêm vào giỏ hàng">

                            </div>
                            <div class="add-to-wishlist">
                                <a class="btn btn-outline-dark btn-hover-primary" href="wishlist.html">Thêm vào yêu
                                    thích</a>
                            </div>
                        </div>
                    </form>
                ...
                <div class="tab-content mb-text" id="myTabContent">
                                    ...
                                    <div class="review_details">
                                        <div class="review_info mb-2">
                                            ...
                                            <div class="review-title-date d-flex">
                                                <h5 class="title"><?= $ten_dang_nhap ?> - </h5><span>
                                                    <?= $ngay_binh_luan ?></span>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-custom">
                                        <?php if (isset($_SESSION['e_user']) && ($_SESSION['e_user'] != "")) { ?>
                                            <!-- Comment form Start -->
                                            <form action="index.php?act=single-product&id=<?= $id ?>"
                                                ...
                                                <div class="comment-form-comment mb-3">
                                                    ...
                                                    <textarea class="comment-notes" name="noi_dung"
                                                ...
                                                <div class="comment-form-submit">
                                                    <input class="btn btn-dark btn-hover-primary" name="binh_luan"
                    ...
                    <div class="tab-pane fade" id="connect-3" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div class="shipping-policy mb-n2">
                            ...
                            <p>- TK MB BANK :0206200455555- Chủ TK : Đàm Văn Quang</p>
                            <p>- TK TP BANK :1026787132- Chủ TK : Đàm Văn Quang</p>
                        </div>
                        <!-- Shipping Policy End -->
                                    ...
                                    <div class="product product-border-left" data-aos="fade-up" data-aos-delay="300">
                                        <div class="thumb">
                                            <a href="index.php?act=single-product&id=<?= $id ?>" class="image">
                                                ...
                                                <img class="first-image" src="<?= $img_path . $anh_sp[0]['anh_sp'] ?>"
                                                    height="269" alt="Product" />
                                                <img class="second-image" src="<?= $img_path . $anh_sp[1]['anh_sp'] ?>"
                                                    height="269" alt="Product" />
                                            </a>
                                            <div class="actions">
                                        ...
                                        <div class="content">
                                            <h4 class="sub-title"><a
                                                    href="index.php?act=single-product&id=<?= $id ?>"><?= $thuong_hieu_sp ?></a>
                                            </h4>
                                            <h5 class="title"><a
                                                    href="index.php?act=single-product&id=<?= $id ?>"><?= $ten_sp ?></a>
                                            </h5>
                                            <!-- <span class="ratings">
                                            <span class="rating-wrap">
                                                <span class="star" style="width: 100%"></span>
                                            ...
                                            <form action="index.php?act=add-cart" method="post">
                                                ...
                                                <input type="hidden" name="anh_sp" value="<?= $link_anh_sp ?>">
                                                <!-- <button class="btn btn-sm btn-outline-dark btn-hover-primary">Thêm vào giỏ hàng</button> -->
                                                <input type="submit" class="btn btn-sm btn-outline-dark btn-hover-primary"
                                                    name="them_vao_gio_hang" value="Thêm vào giỏ hàng">
                                            </form>
                                        </div>
                                    </div>
