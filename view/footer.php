            ...
            <div class="row mb-n10">
                ...
                <div class="col-12 col-sm-6 col-lg-2 col-xl-2 mb-10" data-aos="fade-up" data-aos-delay="300">
                    <div class="single-footer-widget">
                        ...
                        <ul class="widget-list">
                            ...
                            <li><a href="index.php?act=about">Thông tin giao hàng</a></li>
                            <li><a href="index.php?act=about">Chính sách bảo mật</a></li>
                            <li><a href="index.php?act=about">Điều khoản và điều kiện</a></li>
                            <li><a href="index.php?act=about">Dịch vụ khách hàng</a></li>
                            <li><a href="index.php?act=about">Chính sách hoàn trả</a></li>
                        </ul>
                    </div>
                </div>
                <!-- <div class="col-12 col-sm-6 col-lg-2 col-xl-2 mb-10" data-aos="fade-up" data-aos-delay="400">
                        <div class="single-footer-widget aos-init aos-animate">
                            ...
                            <ul class="widget-list">
                                <li><a href="index.php?act=contact">Bản tin</a></li>
                                <li><a href="index.php?act=contact">Trung tâm trợ giúp</a></li>
                                <li><a href="index.php?act=contact">Tình trạng</a></li>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-4 mb-10" data-aos="fade-up" data-aos-delay="500">
                    <div class="single-footer-widget">
                        ...
                        <div class="widget-body">
                            <p class="desc-content mb-0">Nhận thông tin cập nhật qua Email về cửa hàng mới nhất của
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <a class="swiper-slide" href="#">
                                    <img class="w-100" src="view/images/products/large-size/1.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide" href="#">
                                    <img class="w-100" src="view/images/products/large-size/2.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide" href="#">
                                    <img class="w-100" src="view/images/products/large-size/3.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide" href="#">
                                    <img class="w-100" src="view/images/products/large-size/4.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide" href="#">
                                    <img class="w-100" src="view/images/products/large-size/5.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide" href="#">
                                    <img class="w-100" src="view/images/products/large-size/6.jpg" alt="Product">
                                </a>
                            </div>
                    ...
                    <div class="product-summery">
                        ...
                        <div class="cart-wishlist-btn pb-4 mb-n3">
                            <div class="add-to_cart mb-3">
                                <a class="btn btn-outline-dark btn-hover-primary" href="index.php?act=cart">Add to
                                    cart</a>
                            </div>
                            <div class="add-to-wishlist mb-3">
                                <a class="btn btn-outline-dark btn-hover-primary" href="index.php?act=wishlist">Add to
                                    Wishlist</a>
                            </div>
                        </div>
...
<script src="view/js/vendor/bootstrap.bundle.min.js"></script>
<script src="view/js/vendor/jquery-3.6.0.min.js"></script>
<script src="view/js/vendor/jquery-migrate-3.3.2.min.js"></script>
<script src="view/js/vendor/modernizr-3.11.2.min.js"></script>


<!-- Plugins JS -->


<script src="view/js/plugins/countdown.min.js"></script>
<script src="view/js/plugins/aos.min.js"></script>
<script src="view/js/plugins/swiper-bundle.min.js"></script>
<script src="view/js/plugins/nice-select.min.js"></script>
<script src="view/js/plugins/jquery.ajaxchimp.min.js"></script>
<script src="view/js/plugins/jquery-ui.min.js"></script>
<script src="view/js/plugins/lightgallery-all.min.js"></script>
<script src="view/js/plugins/thia-sticky-sidebar.min.js"></script>
...
<!-- Mirrored from htmldemo.net/destry/destry/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Nov 2023 06:16:50 GMT -->
