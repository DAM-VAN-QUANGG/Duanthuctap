        ...
        <div class="row mb-n6">
            <div class="col-lg-6 align-self-center mb-6" data-aos="fade-right" data-aos-delay="600">
                <div class="about_content">
                    ...
                    <p>Chào mừng đến với DVQ-SHOP một trang web bán hàng thời trang nam nữ tuyệt vời! Chúng tôi tự hào
                        ...
                        đem đến cho bạn những bộ trang phục và phụ kiện hoàn hảo để tôn lên cá tính và gu thẩm mỹ riêng
                        của bạn.
                        <br> Slogan của chúng tôi là "Phong cách của bạn, tự tin của bạn" - và chúng tôi tin rằng mỗi
                        người đều có quyền tỏa sáng với phong cách riêng. Từ những bộ áo sơ mi thanh lịch đến những
                        chiếc váy duyên dáng, từ những trang phục thể thao năng động đến những phụ kiện đẳng cấp, chúng
                        tôi sẽ giúp bạn tạo nên một phong cách độc đáo và tự tin.
                        <br> Đặt niềm tin vào chúng tôi, bạn sẽ được trải nghiệm một trang web bán hàng dễ sử dụng, đáng
                        tin cậy và tiện ích. Chúng tôi luôn cam kết đem đến cho bạn những sản phẩm chất lượng, dịch vụ
                        chăm sóc khách hàng tận tâm và trải nghiệm mua sắm trực tuyến dễ dàng.
                        <br> Hãy khám phá ngay hôm nay và biến phong cách của bạn thành một tuyên ngôn cá nhân đầy tự
                        tin!
                    </p>
                </div>
            </div>
            <div class="col-lg-6 mb-6" data-aos="fade-left" data-aos-delay="600">
                <div class="about_thumb">
                    <img class="fit-image" src="view/images/about/1.jpg" alt="About Image">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row mb-n5">
            ...
            <div class="col-lg-3 col-md-6 mb-5" data-aos="fade-up" data-aos-delay="300">
                <div class="feature flex-column text-center">
                    ...
                    <div class="content ps-0 w-100">
                        <h5 class="title mb-2">Miễn phí vận chuyển</h5>
                        <p>Miễn phí vận chuyển cho đơn hàng từ 700000 VNĐ</p>
                    </div>
                </div>
            </div>
            <!-- Feature End -->
            ...
            <div class="col-lg-3 col-md-6 mb-5" data-aos="fade-up" data-aos-delay="400">
                <div class="feature flex-column text-center">
                    ...
                    <div class="content ps-0 w-100">
                        <h5 class="title mb-2">Hỗ trợ 24/7</h5>
            ...
            <div class="col-lg-3 col-md-6 mb-5" data-aos="fade-up" data-aos-delay="500">
                <div class="feature flex-column text-center">
                    ...
                    <div class="content ps-0 w-100">
                        <h5 class="title mb-2">HOÀN TIỀN</h5>
            ...
            <div class="col-lg-3 col-md-6 mb-5" data-aos="fade-up" data-aos-delay="600">
                <div class="feature flex-column text-center">
                    ...
                    <div class="content ps-0 w-100">
                        <h5 class="title mb-2">GIẢM GIÁ ĐƠN HÀNG</h5>
        ...
        <div class="row mb-n6">
            ...
            <div class="col-lg-4 col-md-6 text-center mb-6" data-aos="fade-up" data-aos-delay="600">
                ...
                <div class="single-service">
                    ...
                    <p>Chúng tôi cam kết đem đến trải nghiệm mua sắm thoải mái và vui vẻ. Các chương trình khuyến mãi và
                        ưu đãi thường xuyên được cập nhật để giúp bạn tiết kiệm chi phí và nhận được giá trị tốt nhất.
                    </p>
                </div>
                <!-- Single Service End -->
            </div>
