                    ...
                    <div class="col d-none d-lg-block">
                        <div class="header-top-lan-curr-link">
                            ...
                            <div class="header-top-links">
                                <span>Điện thoại</span><a href="#"> 0867621838</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-6">
                            <div class="header-logo">
                                <a href="index.php"><img src="view/images/logo/logo.png" width="100" height="100"
                                        alt="Site Logo" /></a>
                            </div>
                        </div>
                        <!-- Header Logo End -->
            ...
            <div class="cart-offcanvas-inner">
                ...
                <div class="offcanvas-cart-content">
                            ...
                            <div class="cart-product-wrapper mb-6">
                                ...
                                <div class="single-cart-product">
                                    <div class="cart-product-thumb">
                                        <a href="index.php?act=single-product"><img src="<?= $san_pham[1] ?>"
                                                alt="Cart Product"></a>
                                    </div>
                                ...
                                <div class="cart-product-remove">
                                    <a onclick="xoaKhong('index.php?act=del-cart&idcart=<?= $id ?>')" href="#"><i
                    ...
                    <div class="cart-product-btn mt-4">
                        <a href="index.php?act=cart" class="btn btn-dark btn-hover-primary rounded-0 w-100">Xem giỏ
                            hàng</a>
